...
export const partner = {
  ...
  getAnalyticsOverview: (params) => api.get('partner/analytics/overview/', { params }),
  getSalesTrend: (range) => api.get('partner/analytics/sales-trend/', { params: { range } }),
  getTopProducts: (limit) => api.get('partner/analytics/top-products/', { params: { limit } }),
  getOrderStatusDist: () => api.get('partner/analytics/order-status-distribution/'),
